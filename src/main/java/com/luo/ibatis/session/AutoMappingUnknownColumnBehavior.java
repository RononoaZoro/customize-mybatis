...
/**
 * @author ：archer
 * @date ：Created in 2021/7/1 14:57
 * @description：
...
public enum AutoMappingUnknownColumnBehavior {
    ...
    /**
     * Output warning log.
     * Note: The log level of {@code 'com.luo.ibatis.session.AutoMappingUnknownColumnBehavior'} must be set to {@code WARN}.
     */
    WARNING {
        @Override
        public void doAction(MappedStatement mappedStatement, String columnName, String property, Class<?> propertyType) {
     ...
     * @param propertyType property type for mapping target (If this argument is not null, {@link com.luo.ibatis.type.TypeHandler} for property type is not registered)
     */
