...
//import com.luo.log4j.spi.LoggingEvent;
//import com.luo.log4j.varia.NullAppender;
...
//            assertThat(LastEventSavedAppender.event.getMessage().toString()).isEqualTo("Unknown column is detected on 'com.luo.ibatis.session.AutoMappingUnknownColumnBehaviorTest$Mapper.selectSimpleAuthor' auto-mapping. Mapping parameters are [columnName=ID,propertyName=id,propertyType=java.util.concurrent.atomic.AtomicInteger]");
//        }
//    }
//
//    @Test
...
//            assertThat(e.getCause().getMessage()).isEqualTo("Unknown column is detected on 'com.luo.ibatis.session.AutoMappingUnknownColumnBehaviorTest$Mapper.selectAuthor' auto-mapping. Mapping parameters are [columnName=USERNAMEEEE,propertyName=USERNAMEEEE,propertyType=null]");
//        }
//    }
//
//}
