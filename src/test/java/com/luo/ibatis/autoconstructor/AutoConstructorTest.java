 ...
 */
package com.luo.ibatis.autoconstructor;
...
public class AutoConstructorTest {
  ...
  public static void setUp() throws Exception {
    ...
    try (Reader reader = Resources.getResourceAsReader("com/luo/ibatis/autoconstructor/mybatis-config.xml")) {
      sqlSessionFactory = new SqlSessionFactoryBuilder().build(reader);
    }

    // populate in-memory database
    BaseDataTest.runScript(sqlSessionFactory.getConfiguration().getEnvironment().getDataSource(),
            "com/luo/ibatis/autoconstructor/CreateDB.sql");
  }
