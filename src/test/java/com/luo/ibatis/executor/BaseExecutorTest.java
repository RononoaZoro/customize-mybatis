...
import com.luo.ibatis.transaction.jdbc.JdbcTransaction;
...
//      MappedStatement insertStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareInsertAuthorMappedStatement(config);
//      MappedStatement selectStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectOneAuthorMappedStatement(config);
//      int rows = executor.update(insertStatement, author);
...
//    Executor executor = createExecutor(new JdbcTransaction(ds, null, false));
//    try {
//      MappedStatement selectStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectAllAuthorsAutoMappedStatement(config);
...
//    try {
//      Author author = new Author(-1, "someone", "******", "someone@apache.org", null, Section.NEWS);
//      MappedStatement insertStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareInsertAuthorMappedStatementWithAutoKey(config);
//      MappedStatement selectStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectOneAuthorMappedStatement(config);
//      int rows = executor.update(insertStatement, author);
//      assertTrue(rows > 0 || rows == BatchExecutor.BATCH_UPDATE_RETURN_VALUE);
//      if (rows == BatchExecutor.BATCH_UPDATE_RETURN_VALUE) {
...
//      MappedStatement insertStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareInsertAuthorProc(config);
//      MappedStatement selectStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectOneAuthorMappedStatement(config);
//      int rows = executor.update(insertStatement, author);
...
//      MappedStatement insertStatement = org.apache.ibatis.executor.ExecutorTestHelper.createInsertAuthorWithIDof99MappedStatement(config);
//      MappedStatement selectStatement = org.apache.ibatis.executor.ExecutorTestHelper.createSelectAuthorWithIDof99MappedStatement(config);
...
//      MappedStatement updateStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareUpdateAuthorMappedStatement(config);
//      MappedStatement selectStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectOneAuthorMappedStatement(config);
...
//      MappedStatement deleteStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareDeleteAuthorMappedStatement(config);
//      MappedStatement selectStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectOneAuthorMappedStatement(config);
...
//    Executor executor = createExecutor(new JdbcTransaction(ds, null, false));
//    try {
//      MappedStatement selectStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectDiscriminatedPost(config);
...
//    Executor executor = createExecutor(new JdbcTransaction(ds, null, false));
//    try {
//      MappedStatement selectStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectTwoSetsOfAuthorsProc(config);
...
//    Executor executor = createExecutor(new JdbcTransaction(ds, null, false));
//    try {
//      MappedStatement selectStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectAuthorViaOutParams(config);
...
//    Executor executor = createExecutor(new JdbcTransaction(ds, null, false));
//    try {
//      MappedStatement selectBlog = org.apache.ibatis.executor.ExecutorTestHelper.prepareComplexSelectBlogMappedStatement(config);
//      MappedStatement selectPosts = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectPostsForBlogMappedStatement(config);
...
//    try {
//      MappedStatement selectBlog = org.apache.ibatis.executor.ExecutorTestHelper.prepareComplexSelectBlogMappedStatement(config);
//      MappedStatement selectPost = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectPostMappedStatement(config);
//      config.addMappedStatement(selectBlog);
...
//    Executor executor = createExecutor(new JdbcTransaction(ds, null, false));
//    try {
//      MappedStatement selectBlog = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectBlogByIdAndAuthor(config);
//      MappedStatement selectPost = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectPostWithBlogByAuthorMappedStatement(config);
//      config.addMappedStatement(selectBlog);
//      config.addMappedStatement(selectPost);
...
//    Executor executor = createExecutor(new JdbcTransaction(ds, null, false));
//    try {
//      MappedStatement selectStatement = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectOneAuthorMappedStatementWithConstructorResults(config);
...
//      config.addMappedStatement(selectBlog);
//      config.addMappedStatement(selectPosts);
//      MappedStatement selectAuthor = org.apache.ibatis.executor.ExecutorTestHelper.prepareSelectOneAuthorMappedStatement(config);
//      MappedStatement insertAuthor = org.apache.ibatis.executor.ExecutorTestHelper.prepareInsertAuthorMappedStatement(config);
//
