...
import com.luo.ibatis.builder.xml.XMLMapperBuilder;
...
public class XmlMapperBuilderTest {
    ...
    public void shouldSuccessfullyLoadXMLMapperFile() throws Exception {
        ...
        String resource = "com/luo/ibatis/builder/AuthorMapper.xml";
    ...
    public void resolveJdbcTypeWithUndefinedValue() {
        ...
        then(caughtException())
                ...
                .hasMessageEndingWith("com.luo.ibatis.type.JdbcType.aaa");
    }
    ...
    public void resolveResultSetTypeWithUndefinedValue() {
        ...
        then(caughtException())
                ...
                .hasMessageEndingWith("com.luo.ibatis.mapping.ResultSetType.bbb");
    }
    ...
    public void resolveParameterModeWithUndefinedValue() {
        ...
        then(caughtException())
                ...
                .hasMessageEndingWith("com.luo.ibatis.mapping.ParameterMode.ccc");
    }
    ...
    public void createInstanceWithAbstractClass() {
        ...
        when(builder).createInstance("com.luo.ibatis.builder.BaseBuilder");
        then(caughtException())
                .isInstanceOf(BuilderException.class)
                .hasMessage("Error creating instance. Cause: java.lang.InstantiationException: com.luo.ibatis.builder.BaseBuilder");
    }
    ...
    public void resolveClassWithNotFound() {
        ...
        then(caughtException())
                .isInstanceOf(BuilderException.class)
                .hasMessage("Error resolving class. Cause: com.luo.ibatis.type.TypeException: Could not resolve type alias 'ddd'.  Cause: java.lang.ClassNotFoundException: Cannot find class: ddd");
    }
